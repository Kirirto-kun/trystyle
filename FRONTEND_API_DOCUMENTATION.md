# TryStyle Chat API - Полная документация для фронтенда

## 🎯 Обзор системы

TryStyle использует многоагентную AI-систему на базе **PydanticAI** с тремя специализированными агентами:
